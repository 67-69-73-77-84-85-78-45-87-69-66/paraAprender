/* 
	Para hacer la cuenta regresiva recuerda que las funciones .getSeconds, .getMinutes, etc. Reegresan valores numericos,
	luego, se pueden restar de una fecha para hacer la cuenta regresiva.
*/
